...
const SimpleWhitelistITokenAbstraction = artifacts.require('SimpleWhitelistIToken');
const SimpleWhitelistAbstraction = artifacts.require('SimpleWhitelist');

contract('SimpleWhitelistIToken', function(accounts) {
  ...
  describe('.transfer', () => {
    it('should transfer tokens', async () => {
      ...
      const instance = await SimpleWhitelistITokenAbstraction.new(
        10000,
        'Vanilla',
        'VNL',
        18,
